...
function UploadSubtitlesButton() {
    return (
        <div className='p-2'>
            <Button
                size="lg"
                className=" m-1 bg-transparent border border-gray-300 hover:border-blue-200 hover:bg-sky-100  flex flex-col justify-center items-center"
                style={{
                    width: '100%',
                    height: 'auto',
                    fontSize: '1.2rem',
